...
def run():
    ...
    activities = ["User", "Feedback", "Resume Ranking", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Team 5</a></b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:                
                ...
                elif re.search(r'internships?', resume_text, re.IGNORECASE):
                    cand_level = "Intermediate"
                    st.markdown('''<h4 style='text-align: left; color: #1ed760;'>You are at intermediate level!</h4>''', unsafe_allow_html=True) 
                #### if Work Experience/Experience then Experience level
                elif 'EXPERIENCE' or 'WORK EXPERIENCE' or 'Experience' or 'Work Experience' in resume_text:
                ...
                if 'INTERNSHIPS' or'INTERNSHIP' or 'Internships' or 'Internship' in resume_text:
                    resume_score = resume_score + 6
                ...
                if 'SKILLS' or 'SKILL' or 'Skills' or 'Skill'  in resume_text:
                    resume_score = resume_score + 6
                ...
                if 'INTERESTS' or 'Interests' in resume_text:
                ...
                if 'ACHIEVEMENTS' or 'Achievements' or 'ACCOMPLISHMENTS' or 'Accomplishments' in resume_text:
                    resume_score = resume_score + 8
                    st.markdown('''<h5 style='text-align: left; color: #1ed760;'>[+] Awesome! You have added your Achievements </h4>''',unsafe_allow_html=True)
                else:
                    st.markdown('''<h5 style='text-align: left; color: #000000;'>[-] Please add Achievements. It will show that you are capable for the required position.</h4>''',unsafe_allow_html=True)

                if 'CERTIFICATIONS' or 'Certifications' or 'CERTIFICATION' or 'Certification' in resume_text:
                    resume_score = resume_score + 12
                ...
                if 'PROJECTS' or  'PROJECT' or 'Projects' or 'Project' in resume_text:
    ...
    ###### CODE FOR FEEDBACK SIDE ######
        ...
        if st.button("Rank Resumes") and uploaded_files:
            ...
            for rank, (name, email, similarity) in enumerate(deduplicated_resumes, start=1):
                st.write(f"**Rank:** {rank}, **Name:** {name}, **Email:** {email}, **Similarity:** {similarity:.2f}")

            # Download CSV
            st.subheader("Download CSV")
            csv_content = "Rank,Name,Email,Similarity\n" + "\n".join([f"{rank},{name},{email},{similarity}" for rank, (name, email, similarity) in enumerate(deduplicated_resumes, start=1)])
            st.download_button(label="Download CSV", data=csv_content, file_name="ranked_resumes.csv", mime="text/csv")
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Team 5</a> through 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ## Credentials 
            if ad_user == 'Likhitha' and ad_password == 'Likhi@2003':
